						...
						<div class="col-lg-11">
							<div class="card">
								...
								<div class="card-body card-block">
									<form
										action="/KiemDinhUTT/kiemdinh/taikhoan/update?id_tk=${tkUpdate.id_tk }"
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-3">
												<img
													src="${pageContext.request.contextPath }/upload/user/${tkUpdate.img }"
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="text-input" name="hoten"
													value="${tkUpdate.hoten }" placeholder="Fullname"
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="text-input" name="taikhoan"
													placeholder="Username" class="form-control"
													value="${tkUpdate.taikhoan }"disabled> <small
													class="form-text text-muted">This is a help text</small>
											</div>
										</div>
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="password" id="password-input" name="matkhau"
													placeholder="Password" class="form-control"
													value="${tkUpdate.matkhau }" disabled> <small
													class="form-text text-muted">This is a help text</small>
											</div>
										</div>
										<!--  <div class="row form-group">
											...
											<div class="col col-md-9">
												<div class="form-check-inline form-check">
													<label for="inline-radio1" class="form-check-label ">
														...
														<c:if test="${tkUpdate.gioitinh eq 'Nam' }">checked</c:if>>Nam
														...
														<c:if test="${tkUpdate.gioitinh eq 'Nữ' }">checked</c:if>>Nữ
														...
														<c:if test="${tkUpdate.gioitinh eq 'Khác' }">checked</c:if>>Khác
													</label>
												</div>
											</div>
										</div>
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="text-input" name="diachi"
													...
													value="${tkUpdate.diachi }" required> <small
													class="form-text text-muted">This is a help text</small>
											</div>
										</div>
										<div class="row form-group">
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="text-input" name="sdt"
													...
													value="${tkUpdate.sdt }" required> <small
													class="form-text text-muted">This is a help text</small>
											</div>
										</div>
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<select name="role" id="select" class="form-control"
													required>
													<option value="0"
														<c:if test="${tkUpdate.role eq '0' }">selected</c:if>>Quản
														Trị</option>
													<option value="1"
														<c:if test="${tkUpdate.role eq '1' }">selected</c:if>>Giáo
														Viên</option>
												</select>
											</div>
										</div>
