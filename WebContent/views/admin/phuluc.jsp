								...
								<div class="card-body card-block">
									<div class="table-responsive table-data">
										<table class="table">
											...
											<tbody>
												<div class="table-data__tool">
													<c:forEach items="${phuluc}" var="phuluc">
														<tr>
															<td>
																<div class="table-data__info ">
																	<h6>${phuluc.id_phuluc}</h6>
																</div>
															</td>
															<td>
																<div class="table-data__info">
																	<a
																		href="/KiemDinhUTT/kiemdinh/phuluc/detail?id_phuluc=${phuluc.id_phuluc }"><h6>${phuluc.tenphuluc}</h6></a>
																</div>
															</td>
