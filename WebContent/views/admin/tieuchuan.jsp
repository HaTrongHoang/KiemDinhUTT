								...
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<a
												href="/KiemDinhUTT/kiemdinh/tieuchuan/add"><i
												class="zmdi zmdi-plus"></i>THÊM TIÊU CHUẨN</a>
										</button>
									</div>
									<div class="table-data__tool-right">

										<form class="form-header"
											action="/KiemDinhUTT/kiemdinh/tieuchuan/search"
											method="POST">
								...
								<div class="card-body card-block">
									<div class="table-responsive table-data">
										<table class="table">
											...
											<tbody>
												<div class="table-data__tool">
													<c:forEach items="${tieuChuanList}" var="tieuchuan">
														<tr>
															<td>
															...
															<td>
																<div class="table-data__info" style="width: 500px; word-wrap: break-word;">
																	<h6>${tieuchuan.noidung_tieuchuan}</h6>
																</div>
															</td>
															<td>
