								...
								<div class="card-body card-block">
									<div class="table-responsive table-data">
										<table class="table">
											...
											<tbody>
												<div class="table-data__tool">
													<c:forEach items="${tongquat}" var="tongquat">
														<tr>
															<td>
																<div class="table-data__info ">
																	<h6>${tongquat.id_tongquat}</h6>
																</div>
															</td>
															<td>
																<div class="table-data__info"
																	...
																	<a
																		href="/KiemDinhUTT/kiemdinh/tongquat/detail?id_tongquat=${tongquat.id_tongquat }"><h6>${tongquat.tieude_tongquat}</h6></a>
																</div>
															</td>
															<td>
