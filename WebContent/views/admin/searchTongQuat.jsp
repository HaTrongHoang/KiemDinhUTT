								...
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<a href="/KiemDinhUTT/kiemdinh/tongquat/add"><i
									...
									<div class="table-data__tool-right">
										...
										<form class="form-header"
											action="/KiemDinhUTT/kiemdinh/tongquat/search" method="POST">
								...
								<div class="card-body card-block">
									<div class="table-responsive table-data">
										<table class="table">
											...
											<tbody>
												<div class="table-data__tool">
													<c:forEach items="${tongquatListSearch}"
														var="tongquatListSearch">
														<tr>
															<td>
																<div class="table-data__info ">
																	<h6>${tongquatListSearch.id_tongquat}</h6>
																</div>
															</td>
															<td>
																<div class="table-data__info"
																	...
																	<a
																		href="/KiemDinhUTT/kiemdinh/tongquat/detail?id_tongquat=${tongquatListSearch.id_tongquat }"><h6>${tongquatListSearch.tieude_tongquat}</h6></a>
																</div>
															</td>
															<td>
																<div class="table-data-feature">
																	<button class="item" data-toggle="tooltip"
																		...
																		<a
																			href="/KiemDinhUTT/kiemdinh/tongquat/update?id_tongquat=${tongquat.id_tongquat }">
																	...
																	<button class="item" data-toggle="tooltip"
																		...
																		<a
																			href="/KiemDinhUTT/kiemdinh/tongquat/delete?id_tongquat=${tongquat.id_tongquat }"
