						...
						<div class="col-lg-12">
							...
							<div class="user-data m-b-30">
								<h3 class="title-3 m-b-30">
									<i class="zmdi zmdi-account-calendar"></i>Danh mục "${key }"
								</h3>
								<div class="table-data__tool">
									<div class="table-data__tool-left">
										<button class=" au-btn-icon au-btn--small">
											<a href="/KiemDinhUTT/kiemdinh/phuluc/add"><i
												class="zmdi zmdi-plus"></i>THÊM </a>
										</button>
									</div>
									<div class="table-data__tool-right">

										<form class="form-header"
											action="/KiemDinhUTT/kiemdinh/phuluc/search" method="POST">
								...
								<div class="card-body card-block">
									<div class="table-responsive table-data">
										<table class="table">
											...
											<tbody>
												<div class="table-data__tool">
													<c:forEach items="${phulucListSearch}"
														var="phulucListSearch">
														<tr>
															<td>
																<div class="table-data__info ">
																	<h6>${phulucListSearch.id_phuluc}</h6>
																</div>
															</td>
															<td>
																<div class="table-data__info">
																	<a
																		href="/KiemDinhUTT/kiemdinh/phuluc/detail?id_phuluc=${phulucListSearch.id_phuluc }"><h6>${phulucListSearch.tenphuluc}</h6></a>
																</div>
															</td>
															...
															<td>
																<div class="table-data__info"
																	...
																	<h6>${phulucListSearch.noidung_phuluc}</h6>
																</div>
															</td>
															<td>
																<div class="table-data-feature">
																	<button class="item" data-toggle="tooltip"
																		...
																		<a
																			href="/KiemDinhUTT/kiemdinh/phuluc/update?id_phuluc=${phulucListSearch.id_phuluc }">
																	...
																	<button class="item" data-toggle="tooltip"
																		...
																		<a
																			href="/KiemDinhUTT/kiemdinh/phuluc/delete?id_phuluc=${phulucListSearch.id_phuluc }"
