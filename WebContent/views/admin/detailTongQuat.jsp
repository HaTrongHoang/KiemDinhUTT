...
<!-- Title Page-->
<title>Thông tin tổng quan</title>
							...
							<div class="card-body card-block">
								<div class="row form-group">
									...
									<div class="col-12 col-md-10">
										<label for="text-input" class=" form-control-label">${tongquat.tieude_tongquat }</label>
									</div>
								</div>
								<div class="row form-group">
									<div class="col col-md-2">
									...
									<div class="col-12 col-md-10">
										<label for="text-input" class=" form-control-label">${tongquat.noidung_tongquat }</label>
									</div>
								</div>
