					...
					<div class="col-lg-11">
						<div class="card">
							...
							<div class="card-header">
								<strong>Chỉnh Sửa Tiêu Chí</strong>
							</div>
							<div class="card-body card-block">
								<form action="/KiemDinhUTT/kiemdinh/tieuchi/update?id_tieuchi=${tieuchi.id_tieuchi }" method="post"
									...
									<div class="row form-group">
										...
										<div class="col-12 col-md-9">
											<input type="text" id="text-input" name="tentieuchi"
												class="form-control" value="${tieuchi.tentieuchi }" required>
										</div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3">
										...
										<div class="col-12 col-md-9">
											<textarea name="noidung_tieuchi" id="textarea-input" rows="6"
												class="form-control">${tieuchi.noidung_tieuchi }</textarea>
										</div>
									</div>
