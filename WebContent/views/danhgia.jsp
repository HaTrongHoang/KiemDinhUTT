		...
		<div id="page-wrapper">
			<h3 class="title1">
				<a class="btn btn-primary btn-lg"
					href="/KiemDinhUTT/utt/danhgia/update?id_tieuchi=${tieuchi.id_tieuchi}"
					style="float: right; background-color: #0063af;">Cập nhật </a>${tieuchi.tentieuchi }:
				${tieuchi.noidung_tieuchi }
			</h3>
							...
							<div class="panel-body">
								<div class="panel-heading"
									...
									<h3 class="panel-title"
										style="font-weight: bold; font-size: 18px;">Nội dung đánh
										giá</h3>
								</div>
								<div class="panel-body">
									<p>
									...
									${danhgia.diemmanh }</br>
									<p>
										<strong>Điểm tồn tại:</strong>
									</p>
									${danhgia.diemtontai }</br>
									<p>
										<strong>Kế hoạch:</strong>
									</p>
									${danhgia.kehoach }</br>
									<p>
										<strong>Tự dánh giá:</strong>
									</p>
									${danhgia.tudanhgia }
								</div>
							</div>
